-- VigilAgent Master Supabase 1-Click Production Setup Blueprint
-- Run this script in the Supabase SQL Editor to establish a fully hardened schema with zero linter errors.
...
-- ================================================================
-- SECTION 0: PURGE ALL UNUSED SECONDARY INDEXES & POLICIES FROM LIVE DB
-- ================================================================
